                ...
                <div class="container_create">
                    <form id="create_form" class="bg-white">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre" class="form-control" id="crear_nombre">
                        </div>
                        <div class="mb-3">
                            <label for="text" class="form-label text-dark">Apellido</label>
                            <input type="text" name="apellido" class="form-control" id="crear_apellido">    
                        </div>
                        <div class="mb-3">
                            <label for="number" class="form-label text-dark">DNI</label>
                            <input type="number" class="form-control" id="crear_dni" placeholder="11222333">
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label text-dark">Email</label>
                            <input type="email" class="form-control" id="crear_email" placeholder="nombre@example.com">
                        </div>
                        <div class="mb-3">
                            <label for="contraseña" class="form-label text-dark">Contraseña</label>
                        ...
                        <div class="mb-1">
                            <input type="submit" id="crear_usuario" class="create_action btn btn-outline-info text-primary" value="Ingresar">
